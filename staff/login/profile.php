...
// Kiểm tra đăng nhập & đúng vai trò nhân viên
...
$sql = "SELECT a.*, s.staff_ID FROM Account a 
...
// Xử lý avatar
$avatarPath = '/ShopAnVat/staff/assets/img/default-avatar.png';
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  ...
  <style>
    ...
    .btn-group-custom { text-align: center; margin-top: 25px; }
...
<div class="container profile-container">
  ...
  <div class="text-center">
    ...
    <h3 class="mt-2">Thông tin Nhân viên</h3>
    <p class="text-muted mb-0">Vai trò: Nhân viên xử lý đơn hàng</p>
  </div>
